...
![001-download-virtualbox.png](./001-download-virtualbox.png)
...
![002-run-the-installer.png](./002-run-the-installer.png)

![003-run-the-installer.png](./003-run-the-installer.png)

![004-run-the-installer.png](./004-run-the-installer.png)

![005-run-the-installer.png](./005-run-the-installer.png)

![006-run-the-installer.png](./006-run-the-installer.png)

![007-run-the-installer.png](./007-run-the-installer.png)

![008-run-the-installer.png](./008-run-the-installer.png)

![009-run-the-installer.png](./009-run-the-installer.png)

![010-run-the-installer.png](./010-run-the-installer.png)
...
![011-complete-the-installation.png](./011-complete-the-installation.png)

![012-complete-the-installation.png](./012-complete-the-installation.png)
...
![013-fixing-missing-dependencies-python.png](./013-fixing-missing-dependencies-python.png)
...
![014-fixing-missing-dependencies-python.png](./014-fixing-missing-dependencies-python.png)
...
![015-virtualbox-extension-pack.png](./015-virtualbox-extension-pack.png)

![016-virtualbox-extension-pack.png](./016-virtualbox-extension-pack.png)

![017-virtualbox-extension-pack.png](./017-virtualbox-extension-pack.png)

![018-virtualbox-extension-pack.png](./018-virtualbox-extension-pack.png)

![019-virtualbox-extension-pack.png](./019-virtualbox-extension-pack.png)

To verify the installation, follow these steps in the VirtualBox application:

![020-virtualbox-extension-pack.png](./020-virtualbox-extension-pack.png)

![021-virtualbox-extension-pack.png](./021-virtualbox-extension-pack.png)

![022-virtualbox-extension-pack.png](./022-virtualbox-extension-pack.png)
...
![023-back-to-welcome-screen.png](./023-back-to-welcome-screen.png)

![024-back-to-welcome-screen.png](./024-back-to-welcome-screen.png)

![025-back-to-welcome-screen.png](./025-back-to-welcome-screen.png)

![026-back-to-welcome-screen.png](./026-back-to-welcome-screen.png)
