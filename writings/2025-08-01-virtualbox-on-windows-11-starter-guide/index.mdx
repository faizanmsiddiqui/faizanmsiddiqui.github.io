...
Virtualization is a technology that allows you to create virtual machines (also
known as VMs)[^vm] that can run different operating systems and applications on
a single physical machine. This means you can run multiple operating systems on
the same machine, switch between them easily, and keep them isolated from each
other.
...
![001 download virtualbox](./001-download-virtualbox.png "001 download virtualbox")
...
![002 run the installer](./002-run-the-installer.png "002 run the installer")

![003 run the installer](./003-run-the-installer.png "003 run the installer")

![004 run the installer](./004-run-the-installer.png "004 run the installer")

![005 run the installer](./005-run-the-installer.png "005 run the installer")

![006 run the installer](./006-run-the-installer.png "006 run the installer")

![007 run the installer](./007-run-the-installer.png "007 run the installer")

![008 run the installer](./008-run-the-installer.png "008 run the installer")

![009 run the installer](./009-run-the-installer.png "009 run the installer")

![010 run the installer](./010-run-the-installer.png "010 run the installer")
...
![011 complete the installation](./011-complete-the-installation.png "011 complete the installation")

![012 complete the installation](./012-complete-the-installation.png "012 complete the installation")
...
![013 fixing missing dependencies python](./013-fixing-missing-dependencies-python.png "013 fixing missing dependencies python")
...
![fixing missing dependencies python](./014-fixing-missing-dependencies-python.png "fixing missing dependencies python")
...
![015 virtualbox extension pack](./015-virtualbox-extension-pack.png "015 virtualbox extension pack")

![016 virtualbox extension pack](./016-virtualbox-extension-pack.png "016 virtualbox extension pack")

![017 virtualbox extension pack](./017-virtualbox-extension-pack.png "017 virtualbox extension pack")

![018 virtualbox extension pack](./018-virtualbox-extension-pack.png "018 virtualbox extension pack")

![019 virtualbox extension pack](./019-virtualbox-extension-pack.png "019 virtualbox extension pack")

To verify the installation, follow these steps in the VirtualBox application:

![020 virtualbox extension pack](./020-virtualbox-extension-pack.png "020 virtualbox extension pack")

![021 virtualbox extension pack](./021-virtualbox-extension-pack.png "021 virtualbox extension pack")

![022 virtualbox extension pack](./022-virtualbox-extension-pack.png "022 virtualbox extension pack")
