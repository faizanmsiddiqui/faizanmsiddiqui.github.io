...
24.04 with ROS 2 Jazzy Jalisco. Most of the things copied from the previous
guide:
[**Guide to Install Open-RMF on Ubuntu 24.04 with ROS 2 Kilted Kaiju**](/writings/pages/guide-to-install-open-rmf-on-ubuntu-2404-with-ros-2-kilted-kaiju)
but due to difference in steps this guide is separate. Similar to the previous
