...
description: An in-depth look at HTTPS, its importance, and how it secures web communications.
author: faizan
date: 2025-09-30 00:33:41 +0300
categories: [Article, Networking]
tags: [article, networking, network-protocol, http]
image:
  path: /assets/img/posts/understanding-https/featured-image.png
  thumb: /assets/img/posts/understanding-https/featured-image-thumbnail.png
  lqip: /assets/img/posts/understanding-https/featured-image-thumbnail.png
mermaid: true
---
...
protocol used to communicate and transfer data between client (typically a web
...
identity and establishes an encrypted connection. Once the handshake is
complete, application-layer HTTP requests and responses flow inside the
established encrypted channel. After that, all data exchanged, such as login
credentials, payment details, and personal information, travels through this
encrypted channel, making it difficult for attackers to read or modify.
...
Adopting HTTPS offers several advantages:
...
non-HTTPS websites as "Not Secure," encouraging universal adoption.

<blockquote class="prompt-info" markdown="1">

**INFO**

Services such as [**Let's Encrypt**](https://letsencrypt.org) have made
obtaining certificates free and automated, lowering barriers to implementation.
