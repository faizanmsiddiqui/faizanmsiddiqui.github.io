...
description:
  ...
  network interfaces.
author: faizan
date: 2025-10-03 15:49:37 +0300
categories: [Project, Mini Project]
tags: [flask, mini-project, monitoring, networking, project, python]
image:
...
PyQt5 version:
[**Network Interface Monitor (PyQt5)**](/posts/network-interface-monitor-pyqt5/)
...
![all interface disconnected screenshot](/assets/img/posts/network-interface-monitor-flask/all-interface-disconnected.png)

### wlan0 Connected

![wlan0 connected screenshot](/assets/img/posts/network-interface-monitor-flask/wlan0-connected.png)

### eth0 Connected

![eth0 connected screenshot](/assets/img/posts/network-interface-monitor-flask/eth0-connected.png)
