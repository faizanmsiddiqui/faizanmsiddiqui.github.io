...
| Initialize a new repository     | `git init <name>`             | Creates a new directory with the specified name and initializes it as a Git repository.<br /><br />Example: `git init hello-world` |
