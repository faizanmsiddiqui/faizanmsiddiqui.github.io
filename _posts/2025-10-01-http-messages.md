---
title: HTTP Messages
description: An in-depth look at HTTP request and response messages, their structure, and components.
author: faizan
date: 2025-10-01 10:54:27 +0300
categories: [Article, Networking]
tags: [article, networking, network-protocol, http]
image:
  path: /assets/img/posts/http-messages/featured-image.png
  thumb: /assets/img/posts/http-messages/featured-image-thumbnail.png
  lqip: /assets/img/posts/http-messages/featured-image-thumbnail.png
mermaid: true
---
...
|     `HEAD` | Similar to `GET` but retrieves headers only, without the body.          |
...
|  **Version** | **Description**                                                                                                     |
| -----------: | :------------------------------------------------------------------------------------------------------------------ |
| **HTTP/1.1** | The most widely used version, supporting persistent connections, chunked transfer encoding, and additional headers. |
|   **HTTP/2** | Introduces multiplexing, header compression, and improved performance.                                              |
|   **HTTP/3** | The latest version, built on QUIC, offering improved speed and security.                                            |
...
list of the latest user agent strings can be found at:
...
is a good tool to test HTTP requests directly from the code editor and work with
the same format as shown in the examples above.
...
content, such as `text/html`, `application/json`, or `image/png`.
