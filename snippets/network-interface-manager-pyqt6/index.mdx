...
![enp0s3 default interface screenshot](./enp0s3-default.png)
...
![enp0s3 disabled interface screenshot](./enp0s3-disabled.png)

![enp0s3 enabled interface screenshot](./enp0s3-enabled.png)
