...
Python 3.6 or higher is required. It's recommended to use a virtual environment
...
require modifications to suit specific production environments. For example,
...
[**http://localhost:5000**](http://localhost:5000) to view the network interface
status monitor.
