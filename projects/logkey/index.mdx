...
🌍 [**Web Page**](https://faizanmsiddiqui.github.io/logkey) | 💻
[**Source Code**](https://github.com/faizanmsiddiqui/logkey) | 🚀
[**Releases**](https://github.com/faizanmsiddiqui/logkey/releases)
...
🎁
[**Packages**](https://github.com/faizanmsiddiqui?tab=packages&repo_name=logkey)
| 🐳 [**Docker Hub**](https://hub.docker.com/r/faizanmsiddiqui/logkey)
...
![logkey project banner](https://raw.githubusercontent.com/faizanmsiddiqui/logkey/refs/heads/main/docs/pages/assets/images/banner-standard.png)
...
git clone https://github.com/faizanmsiddiqui/logkey
cd logkey
```

:::info

- `faizanmsiddiqui` is the GitHub username.
...
- `faizanmsiddiqui` is the Docker Hub username.
...
```shell title="Terminal"
docker pull faizanmsiddiqui/logkey
```
...
```shell title="Terminal"
docker run -it --rm -v $(pwd)/:/app/data/ faizanmsiddiqui/logkey \
...
```shell title="Terminal"
docker tag logkey:latest faizanmsiddiqui/logkey:<version>
```
...
```shell title="Terminal"
docker push faizanmsiddiqui/logkey:<version>
```

`latest` tag can also be published:

```shell title="Terminal"
docker push faizanmsiddiqui/logkey:latest
```
...
```shell title="Terminal"
docker pull faizanmsiddiqui/logkey:<version>
```

or

```shell title="Terminal"
docker pull faizanmsiddiqui/logkey:latest
```
...
- [**Changelog**](https://github.com/faizanmsiddiqui/logkey/blob/main/docs/CHANGELOG.md):
  Changelog of all notable changes.
- [**Code of Conduct**](https://github.com/faizanmsiddiqui/logkey/blob/main/docs/CODE-OF-CONDUCT.md):
  Code of Conduct for contributors.
- [**Commit Message Instructions**](https://github.com/faizanmsiddiqui/logkey/blob/main/.github/copilot/commit-message-instructions.md):
  Commit message guidelines for contributors and Copilot.
- [**Contribution Guidelines**](https://github.com/faizanmsiddiqui/logkey/blob/main/docs/CONTRIBUTING.md):
  How to contribute to this project.
- [**License**](https://github.com/faizanmsiddiqui/logkey/blob/main/LICENSE.md):
  License text.
- [**Pull Request Description Instructions**](https://github.com/faizanmsiddiqui/logkey/blob/main/.github/copilot/pull-request-description-instructions.md):
  Pull request guidelines for contributors and Copilot.
- [**Roadmap**](https://github.com/faizanmsiddiqui/logkey/blob/main/docs/ROADMAP.md):
  High-level strategic plan, long-term goals, milestones, and overall project
  vision.
- [**Security Policy**](https://github.com/faizanmsiddiqui/logkey/blob/main/docs/SECURITY.md):
  Security policy and reporting instructions.
- [**Todo**](https://github.com/faizanmsiddiqui/logkey/blob/main/docs/TODO.md):
  Day-to-day task tracking and immediate execution.

## 📜 License

This project is licensed under the
[**MIT License**](https://github.com/faizanmsiddiqui/logkey/blob/main/LICENSE.md),
