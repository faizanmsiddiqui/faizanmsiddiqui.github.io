...
![Screenshot of VirtualBox download page](./download-virtualbox.png)
...
![Screenshot of running the installer](./run-the-installer-01.png)

![Screenshot of running the installer](./run-the-installer-02.png)

![Screenshot of running the installer](./run-the-installer-03.png)

![Screenshot of running the installer](./run-the-installer-04.png)

![Screenshot of running the installer](./run-the-installer-05.png)

![Screenshot of running the installer](./run-the-installer-06.png)

![Screenshot of running the installer](./run-the-installer-07.png)

![Screenshot of running the installer](./run-the-installer-08.png)

![Screenshot of running the installer](./run-the-installer-09.png)
...
![Screenshot of completing the installation](./complete-the-installation-01.png)

![Screenshot of completing the installation](./complete-the-installation-02.png)
...
![Screenshot of missing dependencies warning](./run-the-installer-06.png)
...
![Screenshot of installing pywin32](./fixing-missing-dependencies-python-01.png)
...
![Screenshot of verifying pywin32 installation](./fixing-missing-dependencies-python-02.png)
...
![Screenshot of downloading VirtualBox Extension Pack](./virtualbox-extension-pack-01.png)

![Screenshot of running the Extension Pack installer](./virtualbox-extension-pack-02.png)

![Screenshot of running the Extension Pack installer](./virtualbox-extension-pack-03.png)

![Screenshot of running the Extension Pack installer](./virtualbox-extension-pack-04.png)

![Screenshot of running the Extension Pack installer](./virtualbox-extension-pack-05.png)
...
![Screenshot of verifying Extension Pack installation](./virtualbox-extension-pack-06.png)

![Screenshot of verifying Extension Pack installation](./virtualbox-extension-pack-07.png)

![Screenshot of verifying Extension Pack installation](./virtualbox-extension-pack-08.png)
...
![Screenshot of returning to the Welcome screen](./back-to-welcome-screen-01.png)

![Screenshot of returning to the Welcome screen](./back-to-welcome-screen-02.png)

![Screenshot of returning to the Welcome screen](./back-to-welcome-screen-03.png)

![Screenshot of returning to the Welcome screen](./back-to-welcome-screen-04.png)
