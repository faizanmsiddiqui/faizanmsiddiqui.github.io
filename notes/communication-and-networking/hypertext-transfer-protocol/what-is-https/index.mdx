...
sequenceDiagram
    ...
    Note over Client,Server: Handshake complete secure channel established
...
- **Authentication:** Certificates verify that the client communicates with the
  intended server.
- **Trust and SEO Advantage:** Search engines favor HTTPS-enabled websites, and
  users gain confidence when accessing them.
