...
This is a living cheat sheet that evolves with regular updates which simply
means currently, this cheat sheet covers basic commands but will be expanded to
include more advanced commands in the future.
