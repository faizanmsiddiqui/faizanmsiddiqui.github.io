...
| :------------------------------ | :---------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Initialize a new repository     | `git init <name>`             | Creates a new Git repository with the specified name.<br /><br />Note: It is better to avoid spaces in repository names.<br /><br />Example: `git init hello-world` |
