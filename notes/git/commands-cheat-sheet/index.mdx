...
| :------------------------------ | :---------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Initialize a new repository     | `git init <name>`             | Creates a new Git repository with the specified name.<br /><br />Note: It is better to avoid space in repository name.<br /><br />Example: `git init hello-world` |
