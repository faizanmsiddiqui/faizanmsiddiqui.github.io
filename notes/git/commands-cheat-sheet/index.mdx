...
| Initialize a new repository     | `git init <name>`             | Creates a new directory with the specified name and initialed it as Git repository.<br /><br />Note: It is better to avoid spaces in names.<br /><br />Example: `git init hello-world` |
